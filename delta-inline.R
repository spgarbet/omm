...
orig.time <- system.time(replicate(1000, delta_it(mm, mm.lag, gamma.mat)))
reference <- delta_it(mm, mm.lag, gamma.mat)
...
# Let's test it
if(abs(sum(reference - delta_it_c(mm, mm.lag, gamma.mat))) > 1e-9)
  stop("C Version Broken!")

inline.time <- system.time(replicate(1000, delta_it_c(mm, mm.lag, gamma.mat)))
